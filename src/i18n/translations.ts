...
export const UI: Record<Lang, Dict> = {
  en: {
    ...
    'nav.origin': 'Origin',
    'nav.contact': 'Contact',
    'brand.tagline': 'Global Engine',
    'badge.location': 'ALGERIA // GLOBAL',
    'btn.startProject': 'Start Project',
    'btn.watchReel': 'Watch Reel',
    'btn.watchShowreel': 'Watch Showreel',
    ...
    'hero.eyebrow': 'SOLO CREATIVE ARCHITECTURE',
    ...
    'hero.footer.year': '© 2026 INTEGRATED PRODUCTION',
    'hero.footer.direct': 'DIRECT FOUNDER COMMUNICATION',
    'hero.footer.manyHeads': 'MANY HEADS. ONE VISION.',
    'hero.badge.videoEdit': 'Video Edit',
    'hero.badge.motion3d': 'Motion 3D',
    'hero.badge.vocalArt': 'Vocal Art',
    ...
    'about.badgeSub': 'AKA HYDRA SAMO // SOLO ARCHITECT',
    'about.badgeActive': 'ACTIVE',
    ...
    'work.bannerTitle': 'Want to see the raw pacing and rhythm?',
    'work.bannerDesc':
      'Explore my 2-minute master showreel featuring commercial edits, motion overlays, and voice reels.',
    ...
    'contact.eyebrow': 'A REAL PERSON, ONE MESSAGE AWAY',
    'contact.let': 'LET\'S',
    'contact.headingBuild': 'BUILD SOMETHING.',
    'contact.intro':
      'Tell me about your project in your own words — no account managers, no runaround. You\'ll hear back from me personally within 24 hours with honest advice, a realistic plan, and a straight price.',
    ...
    'contact.footer': '© {year} HYDRA SAMO // BENDALI ISSAM EDDINE',
    'contact.footerGlobal': 'GLOBAL / REMOTE STUDIO',
    'contact.footerDirect': 'DIRECT ENGAGEMENT',
    'splash.status1': 'ACCESSING HYDRA\'S VAULT...',
    'splash.status2': 'UNLOCKING HYDRA\'S VAULT...',
    'splash.status3': 'LOADING HD SHOWCASES & REELS...',
    'splash.status4': 'GRANTING ACCESS...',
    'splash.status5': 'VAULT UNLOCKED',
    'splash.restricted': 'RESTRICTED CREATIVE VAULT',
    'splash.welcomeTo': 'WELCOME TO',
    'splash.title': 'HYDRA\'S',
    'splash.titleGrad': 'VAULT',
  ...
  fr: {
    ...
    'nav.origin': 'Origine',
    'nav.contact': 'Contact',
    'brand.tagline': 'Moteur Global',
    'badge.location': 'ALGÉRIE // MONDE',
    'btn.startProject': 'Lancer un Projet',
    'btn.watchReel': 'Voir la Démo',
    'btn.watchShowreel': 'Voir le Showreel',
    ...
    'hero.eyebrow': 'ARCHITECTURE CRÉATIVE SOLO',
    ...
    'hero.footer.year': '© 2026 PRODUCTION INTÉGRÉE',
    'hero.footer.direct': 'COMMUNICATION DIRECTE AVEC LE FONDATEUR',
    'hero.footer.manyHeads': 'PLUSIEURS TÊTES. UNE SEULE VISION.',
    'hero.badge.videoEdit': 'Montage Vidéo',
    'hero.badge.motion3d': 'Motion 3D',
    'hero.badge.vocalArt': 'Art Vocal',
    ...
    'about.badgeName': 'BENDALI ISSAM EDDINE',
    'about.badgeSub': 'ALIAS HYDRA SAMO // ARCHITECTE SOLO',
    'about.badgeActive': 'ACTIF',
    'about.p1a': 'Je suis',
    ...
    'work.bannerTitle': 'Envie de voir le rythme et le tempo bruts ?',
    'work.bannerDesc':
      'Découvrez mon master showreel de 2 minutes : spots publicitaires, habillages motion et démos vocales.',
    ...
    'contact.eyebrow': 'UNE VRAIE PERSONNE, À UN MESSAGE',
    'contact.let': 'CRÉONS',
    'contact.headingBuild': 'QUELQUE CHOSE DE GRAND.',
    'contact.intro':
      'Racontez-moi votre projet avec vos propres mots — sans intermédiaires ni chefs de compte. Vous recevrez une réponse personnelle sous 24 heures, avec un avis honnête, un plan réaliste et un tarif clair.',
    ...
    'contact.footer': '© {year} HYDRA SAMO // BENDALI ISSAM EDDINE',
    'contact.footerGlobal': 'STUDIO GLOBAL / À DISTANCE',
    'contact.footerDirect': 'ENGAGEMENT DIRECT',
    'splash.status1': 'ACCÈS AU COFFRE HYDRA...',
    'splash.status2': 'DÉVERROUILLAGE DU COFFRE...',
    'splash.status3': 'CHARGEMENT DES SHOWCASE HD & DÉMOS...',
    'splash.status4': 'ACCÈS AUTORISÉ...',
    'splash.status5': 'COFFRE DÉVERROUILLÉ',
    'splash.restricted': 'COFFRE CRÉATIF RESTREINT',
    'splash.welcomeTo': 'BIENVENUE DANS',
    'splash.title': 'LE COFFRE',
  ...
  ar: {
    ...
    'nav.origin': 'البداية',
    'nav.contact': 'تواصل',
    'brand.tagline': 'محرّك عالمي',
    'badge.location': 'الجزائر // العالم',
    'btn.startProject': 'ابدأ مشروعك',
    'btn.watchReel': 'شاهد الديمو',
    'btn.watchShowreel': 'شاهد العرض',
    ...
    'hero.eyebrow': 'هندسة إبداعية فردية',
    ...
    'hero.footer.year': '© 2026 إنتاج متكامل',
    'hero.footer.direct': 'تواصل مباشر مع المؤسس',
    'hero.footer.manyHeads': 'رؤوس متعددة. رؤية واحدة.',
    'hero.badge.videoEdit': 'مونتاج فيديو',
    'hero.badge.motion3d': 'موشن 3D',
    'hero.badge.vocalArt': 'فن صوتي',
    ...
    'about.badgeSub': 'ويعرف بـ هيدرا سامو // معماري فردي',
    'about.badgeActive': 'نشط',
    'about.p1a': 'اسمي',
    ...
    'work.bannerTitle': 'تريد رؤية الإيقاع الخام والإحساس؟',
    'work.bannerDesc':
      'استكشف عرضي الرئيسي في دقيقتين: إعلانات تجارية، وتغطيات موشن، وديموهات صوتية.',
    ...
    'contact.eyebrow': 'إنسان حقيقي، على بُعد رسالة',
    'contact.let': 'لنصنع',
    'contact.headingBuild': 'شيئاً جديداً.',
    'contact.intro':
      'حدّثني عن مشروعك بكلماتك أنت — دون وسطاء أو مدراء حسابات. سأرد عليك شخصياً خلال 24 ساعة بنصيحة صادقة وخطة واضحة وسعر مباشر.',
    ...
    'contact.footer': '© {year} هيدرا سامو // بن دالي عصام الدين',
    'contact.footerGlobal': 'استوديو عالمي / عن بُعد',
    'contact.footerDirect': 'تعامل مباشر',
    'splash.status1': 'الوصول إلى خزنة هيدرا...',
    'splash.status2': 'جارٍ فتح الخزنة...',
    'splash.status3': 'تحميل العروض والديموهات...',
    'splash.status4': 'منح الإذن...',
    'splash.status5': 'فُتحت الخزنة',
    'splash.restricted': 'خزنة إبداعية خاصة',
