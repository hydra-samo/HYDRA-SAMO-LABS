...
/* Certified HYDRA SAMO V4 mark geometry. HEAD_PATH is the master serpent head
   (apex at 50,11.5 → core junction at 50,33); the two lower heads are this
   path rotated 120°/240° about the emblem centre (50,50). CORE_PATH is the
   R17 pointy-top hexagon. */
