...
export const ContactSection: React.FC<ContactSectionProps> = ({ onCloseModal }) => {
  ...
  const glassSelect = cn(glassInput, 'appearance-none cursor-pointer pe-10');
    ...
    >
      ...
      >
        <button
          ...
          className="absolute top-5 end-5 p-2.5 min-w-[44px] min-h-[44px] rounded-full bg-[#fffdf5]/70 dark:bg-white/5 border border-[var(--border-color)] text-slate-700 dark:text-white/70 hover:text-slate-950 dark:hover:text-white flex items-center justify-center backdrop-blur-md"
        >
          <X size={20} />
        </button>
