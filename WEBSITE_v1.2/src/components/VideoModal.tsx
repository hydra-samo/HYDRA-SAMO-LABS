...
import { X, Play, Pause, Volume2, VolumeX, CheckCircle2, ArrowRight, ArrowLeft } from 'lucide-react';
              ...
              <div className="relative aspect-video w-full rounded-2xl overflow-hidden border border-white/10 select-none">
                ...
                >
                  <img
                    ...
                    style={{ width: '100%' }}
                  />
                  <span className="absolute top-4 start-4 px-3 py-1 bg-black/80 text-white text-xs font-mono rounded">
                    {t('modal.raw')}
                  </span>
                </div>

                <span className="absolute top-4 end-4 px-3 py-1 bg-accent/20 text-accent border border-accent/40 text-xs font-mono rounded font-semibold backdrop-blur-sm">
                  {t('modal.grade')}
                </span>
